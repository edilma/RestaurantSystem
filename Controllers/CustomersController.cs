...
namespace RestaurantSystem.Views.Customers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(RestaurantSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,PhoneNumber,Name,LastName,Address,ZipCode")] Customer customer)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,PhoneNumber,Name,LastName,Address,ZipCode")] Customer customer)
        {
            if (id != customer.ID)
            {
                return NotFound();
